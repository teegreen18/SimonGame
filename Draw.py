...
# Caches the last 5 images loaded.
...
# keeps up to 5 photo images alive at any given time. 
...
def _getPhotoImageReference(w, h):
    ...
    # We're only going to cache 5 of these at any given time
    if len(_imageRefs) >= 5: _imageRefs.pop(0)
